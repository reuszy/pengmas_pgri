    ...
    <main class="bg-[#0a1b3d] flex-grow flex flex-col items-center justify-center p-10">
        ...
        <form action="{{ route('siswa.login.submit') }}" method="POST"
            ...
            <div class="flex items-center gap-10 mb-5">
                ...
                <input type="text" id="nis" name="nis" class="rounded-lg bg-blue-100 px-2 py-1 w-full mt-2">
            </div>
            ...
            <a href="{{ route('siswa.lupa_password') }}" 
   class="text-xs text-blue-800 hover:underline float-right mb-4">
    Lupa Password?
</a>
